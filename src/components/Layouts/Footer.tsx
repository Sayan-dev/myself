...
const Footer = () => {
  return (
    <Box className="bg-primary-2 flex flex-col justify-center items-center mt-10 py-5">
      <Group className="justify-center items-center pb-5">
        <a target="_blank" href="https://github.com/Sayan-dev">
          <Box className="h-[24px] w-[24px] rounded-full">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
